# Recall that a debugger is a computer program that is used to test and find bugs (debug) other programs.
# In this lab, you will use the Python Debugger (pdb) to find and fix bugs in a Python program.
